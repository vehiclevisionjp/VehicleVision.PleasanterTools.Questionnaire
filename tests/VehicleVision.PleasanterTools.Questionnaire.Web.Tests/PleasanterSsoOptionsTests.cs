...
public class PleasanterSsoOptionsTests
{
    ...
    public void 有効にすると内部URLの末尾をそろえる()
    {
        ...
        Assert.Equal(new Uri("http://pleasanter:8080/api/extended/sql"), options.ExtendedSqlUrl);
    }
    ...
    public void 数値と列挙を読む()
    {
        ...
        values[PleasanterSsoOptions.SqlNameKey] = "WhoAmI";
        ...
        Assert.Equal("WhoAmI", options.SqlName);
