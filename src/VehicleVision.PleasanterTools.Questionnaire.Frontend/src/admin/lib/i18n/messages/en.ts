...
export const en: Record<MessageKey, string> = {
  ...
  "pleasanterSso.allowedDeptIds": "Allowed department IDs",
  "pleasanterSso.allowedGroupIds": "Allowed group IDs",
  "pleasanterSso.membershipHint": "Enter positive IDs separated by commas (up to 64 each). Membership in either list permits sign-in. Groups include department members and child groups. If both lists are empty, existing users can sign in but automatic registration is denied. Membership is checked at sign-in and on revalidation.",
  "signIn.pleasanterError.notAllowed": "Access to this application is not allowed. Ask an administrator to check the allowed departments and groups.",
  'pleasanterSso.open': 'Pleasanter sign-in settings',
  'pleasanterSso.title': 'Pleasanter sign-in settings',
  'pleasanterSso.lead': 'Lets people who are signed in to Pleasanter enter the admin screen directly. This application\'s server forwards the browser\'s Pleasanter cookies to the Pleasanter API to identify the user. No API key is sent to the browser.',
  'pleasanterSso.prerequisitesTitle': 'This application and Pleasanter must run under the same host name.',
  'pleasanterSso.prerequisites': 'Cookies are only sent per host name. Keep TokenCheck in Security.json set to false, and allow this application\'s server if you use IP restrictions. See the operations guide for details.',
