export const ja = {
  ...
  'pleasanterSso.lead': 'Pleasanter にログインしている人が、そのまま管理画面へ入れるようにします。ブラウザの Pleasanter の cookie を本アプリのサーバが Pleasanter の拡張 SQL へ転送して本人を確かめます。API キーは使いません。',
  'pleasanterSso.prerequisitesTitle': '本アプリと Pleasanter を同じホスト名で動かす必要があります。',
  'pleasanterSso.prerequisites': 'cookie はホスト名ごとにしか届きません。Pleasanter 側に拡張 SQL の定義を置き、Security.json の TokenCheck を false のままにし、IP 制限を使う場合は本アプリのサーバを許可してください。詳しくは運用手順書を参照してください。',
  ...
  'pleasanterSso.sqlNameHint': 'Pleasanter の App_Data/Parameters/ExtendedSqls に置いた定義の Name です。',
  ...
  'pleasanterSso.testUpstreamError': 'Pleasanter に問い合わせできませんでした（{reason}）。内部 URL、拡張 SQL の名前と定義、IP 制限、TokenCheck を確認してください。',
