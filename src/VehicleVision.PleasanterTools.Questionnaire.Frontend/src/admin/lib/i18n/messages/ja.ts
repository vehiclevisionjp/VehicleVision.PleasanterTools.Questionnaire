export const ja = {
  ...
  'breadcrumb.pleasanterSsoSettings': 'Pleasanter ログイン設定',
  'breadcrumb.help': '使い方',
  ...
  'signIn.pleasanterButton': 'Pleasanter でログイン',
  'signIn.pleasanterWaiting': '開いたウィンドウで Pleasanter にログインしてください。ログインが済むと自動で先へ進みます。',
  'signIn.pleasanterPopupBlocked': 'ログイン画面を別のウィンドウで開けませんでした。下のリンクから開いてください。',
  'signIn.pleasanterOpenLogin': 'Pleasanter のログイン画面を開く',
  'signIn.pleasanterCancel': '待つのをやめる',
  'signIn.pleasanterError.unknownUser': 'この Pleasanter のアカウントは、本アプリの管理者として登録されていません。管理者にお問い合わせください。',
  'signIn.pleasanterError.disabled': 'このアカウントは利用を停止されています。管理者にお問い合わせください。',
  'signIn.pleasanterError.setupRequired': '最初の管理者を登録するまで、Pleasanter のログインは使えません。',
  'signIn.pleasanterError.upstream': 'Pleasanter に問い合わせできませんでした。しばらくしてからもう一度お試しください。',
  'signIn.pleasanterError.rateLimited': '問い合わせが多すぎます。しばらく待ってからもう一度お試しください。',
  'signIn.pleasanterError.unavailable': 'Pleasanter のログインは現在使えません。',
  'signIn.pleasanterError.timeout': 'Pleasanter でのログインを確認できないまま時間が過ぎました。もう一度お試しください。',
  'signIn.pleasanterError.failed': 'Pleasanter のログインを完了できませんでした。もう一度お試しください。',
  'saml.open': 'SAML 設定',
  'saml.title': 'SAML 設定',
  'saml.lead':
  ...
  "pleasanterSso.allowedDeptIds": "許可する組織 ID",
  "pleasanterSso.allowedGroupIds": "許可するグループ ID",
  "pleasanterSso.membershipHint": "正の ID をカンマで区切って入力してください（各 64 件まで）。どちらかに所属する利用者だけがログインできます。グループは組織メンバーと子グループも含みます。両方空の場合、登録済みの利用者はログインできますが、自動登録は拒否します。所属はログイン時と再確認時に調べます。",
  "signIn.pleasanterError.notAllowed": "このアプリの利用が許可されていません。管理者に許可する組織・グループの設定を確認してください。",
  'pleasanterSso.open': 'Pleasanter ログイン設定',
  'pleasanterSso.title': 'Pleasanter ログイン設定',
  'pleasanterSso.lead': 'Pleasanter にログインしている人が、そのまま管理画面へ入れるようにします。ブラウザの Pleasanter の cookie を本アプリのサーバが Pleasanter の API へ転送して本人を確かめます。API キーはブラウザへ渡しません。',
  'pleasanterSso.prerequisitesTitle': '本アプリと Pleasanter を同じホスト名で動かす必要があります。',
  'pleasanterSso.prerequisites': 'cookie はホスト名ごとにしか届きません。Security.json の TokenCheck を false のままにし、IP 制限を使う場合は本アプリのサーバを許可してください。詳しくは運用手順書を参照してください。',
  'pleasanterSso.fixed': '設定で固定されています',
  'pleasanterSso.enabled': 'Pleasanter のログインを有効にする',
  'pleasanterSso.internalBaseUrl': 'Pleasanter の内部 URL（サーバ間）',
  'pleasanterSso.internalBaseUrlHint': '本アプリのサーバから Pleasanter へ届く URL です（例: http://localhost:8080/）。ブラウザには渡しません。',
  'pleasanterSso.loginUrl': 'Pleasanter のログイン画面',
  ...
  'pleasanterSso.registerRole': 'その場で登録するときの役割',
  'pleasanterSso.revalidateMinutes': 'Pleasanter に確かめ直す間隔（分）',
  'pleasanterSso.revalidateMinutesHint': 'Pleasanter でログアウトした人は、この間隔のうちに本アプリからもログアウトされます（1〜60）。',
  'pleasanterSso.timeoutSeconds': '問い合わせを待つ時間（秒）',
  'pleasanterSso.buttonLabel': 'ログイン画面のボタン表示',
  'pleasanterSso.save': '保存する',
  'pleasanterSso.saving': '処理しています…',
  'pleasanterSso.saved': 'Pleasanter ログイン設定を保存しました。',
  'pleasanterSso.testTitle': '接続の試験',
  'pleasanterSso.testLead': '入力中の値で Pleasanter に問い合わせます（保存はしません）。同じブラウザで Pleasanter にログインしてから押してください。',
  'pleasanterSso.test': 'Pleasanter に問い合わせる',
