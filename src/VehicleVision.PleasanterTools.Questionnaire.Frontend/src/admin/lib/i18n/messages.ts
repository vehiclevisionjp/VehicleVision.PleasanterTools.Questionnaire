...
export const ja = {
  ...
  'enroll.leadStrong': 'パスワードだけでは通しません。',
  ...
  'mapping.selectQuestion': '設問を選ぶ',
  'mapping.selectRow': '行を選ぶ',
  'mapping.selectPort': '口を選ぶ',
  'mapping.selectConverter': '変換を選ぶ',
  ...
  'attachmentRejection.lead': '検査で弾いた添付の記録です。',
  'attachmentRejection.leadStrong': '送信元もファイル名も残していません。',
  'attachmentRejection.recent': '直近 {days} 日で {count} 件を弾きました。',
  'attachmentRejection.none': '弾いた添付はありません。',
  ...
  'attachmentRejection.ScannerUnavailable': '検査に到達できない',
  ...
  'theme.accentTextColor': '釦の文字の色',
  'theme.surfaceColor': '入力欄の地の色',
  'theme.borderColor': '枠線の色',
  'theme.preset': '配色',
  'theme.presetHint':
    '名前の付いた組み合わせから選べます。選んだうえで、下の「色を個別に指定する」で 1 色だけ変えることもできます。',
  'theme.showDetails': '色を個別に指定する',
  'theme.hideDetails': '個別の指定を畳む',
  'theme.contrastWarning': '読みにくい組み合わせがあります。保存はできますが、確かめてください。',
  'theme.contrastText': '地の色と文字の色',
  'theme.contrastAccent': '釦の地と釦の文字',
  'theme.contrastSurface': '入力欄の地と文字の色',
