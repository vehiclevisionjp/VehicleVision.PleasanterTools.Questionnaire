...
if (mailOptions.IsReady)
{
    ...
    var configuredMailSenderOptions = MailSenderOptions.FromConfiguration(builder.Configuration);
    builder.Services.AddSingleton(configuredMailSenderOptions);
    builder.Services.AddSingleton<MailSender>();
    builder.Services.AddHostedService<MailSenderHostedService>();
    var configuredNotificationOptions =
        ResponseNotificationMailerOptions.FromConfiguration(builder.Configuration);
    builder.Services.AddSingleton(configuredNotificationOptions);
