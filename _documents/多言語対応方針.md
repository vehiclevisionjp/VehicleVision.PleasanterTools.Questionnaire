...
**鍵の数（2026-09-25、`npm run i18n:status` で数えた）。** 回答画面は 7 言語とも 124 / 124 件、
管理画面は 7 言語とも 989 / 989 件。Issue #464 で足した Pleasanter のログイン設定の文言
（`pleasanterSso.*` の 31 件）も Issue #483 で `zh`・`de`・`ko`・`es`・`vi` へ訳した。
