...
| `VirusScan.Provider` | `ClamAv` | `ClamAv` / `DefenderForStorage` |
| `VirusScan.ClamAv.Host` / `Port` | — | clamd の接続先 |
| `VirusScan.ClamAv.TimeoutSeconds` | 30 | 1 件あたりの上限 |
| `VirusScan.DefenderForStorage.*` | — | DMZ コンテナ・Event Grid の受け口 |
