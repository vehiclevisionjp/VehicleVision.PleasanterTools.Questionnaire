...
| ジョブ | すること |
|---|---|
| `リリース検証` | タグの形式・タグが `master` に含まれること・`VersionPrefix` との一致・ビルド・単体テスト・フロントエンド・`license-check.sh`・`notice-check.sh` |
| `GitHub Release 作成` | 日本語の本文を組み立てて `gh release create`。ライセンス 4 ファイルを添付 |
